...
namespace Caramel
{
	...
	public:
		...
		inline static void SetMousePosition(glm::vec2 pos) { s_Instance->SetMousePositionImpl(pos); }

		static void Init(Input* impl) { s_Instance = impl; }

	protected:
		virtual bool IsKeyPressedImpl(KeyCode code) = 0;
		virtual bool IsMouseButtonPressedImpl(int button) = 0;
		virtual glm::vec2 GetMousePositionImpl() = 0;
		virtual void SetMousePositionImpl(glm::vec2 pos) = 0;
