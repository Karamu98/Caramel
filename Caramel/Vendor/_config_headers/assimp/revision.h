...
#define GitVersion 1//0x@GIT_COMMIT_HASH@
#define GitBranch "1"//"@GIT_BRANCH@"

#define VER_MAJOR 1//@ASSIMP_VERSION_MAJOR@
#define VER_MINOR 1//@ASSIMP_VERSION_MINOR@
#define VER_PATCH 1//@ASSIMP_VERSION_PATCH@
#define VER_BUILD 1//@ASSIMP_PACKAGE_VERSION@
